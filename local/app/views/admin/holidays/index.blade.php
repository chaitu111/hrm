                     ...
                     <table class="table table-hover">
                        ...
                        <tbody>
                           ...
                           <tr id="row{{ $holidaysArray[$month]['id'][$i] }}">
                              ...
                              <td>
																 <a class="btn purple" data-toggle="modal" href="#edit_static"
																 onclick="showEdit('{{ $holidaysArray[$month]['id'][$i] }}','{{ $holidaysArray[$month]['date'][$i] }}','{{ $holidaysArray[$month]['ocassion'][$i] }}')">
            ...
            <div class="portlet-body form">
               ...
               <div class="form-body">
                  <div class="form-group">
                     <div class="col-md-6">
                        <input class="form-control form-control-inline input-medium date date-picker" data-date-format="dd-mm-yyyy" name="date[0]" type="text" value="" placeholder="Date"/>
                     </div>
                     <div class="col-md-6">
...
{{--Add Holidays MODALS--}}
{{--------------------------EDIT MODALS-----------------}}
<div id="edit_static" class="modal fade" tabindex="-1" data-backdrop="static" data-keyboard="false" aria-hidden="false">
   <div class="modal-dialog">
      <div class="modal-content">
         <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
            <h4 class="modal-title"><strong><i class="fa fa-edit"></i> Edit Holidays</strong></h4>
         </div>
				   <div class="modal-body">
            <div class="portlet-body form">
               <!-- BEGIN FORM-->
               ...
               <div class="form-body">
                  <div class="form-group">
                     <div class="col-md-6">
                        <input class="form-control form-control-inline input-medium date-picker" data-date-format="dd-mm-yyyy" name="date[0]" id="date" type="text" value="" placeholder="Date"/>
                     </div>
                     <div class="col-md-6">
                        <input class="form-control form-control-inline"  type="text" name="occasion[0]" id="occasion" placeholder="Occasion"/>
                     </div>
                  </div>
               </div>
							 <div class="form-actions">
...
<script>
 ...
 function showEdit(id,deptName,occasion)
 {
		 $('div[id^="edit_field"]').remove();
		 // var url = "{{ route('admin.holidays.update',':id') }}";
		 // url = url.replace(':id',id);
		 // $('#edit_form').attr('action',url );
		 var get_url = "{{ route('admin.holidays.edit',':id') }}";
